import intro from "./../files/illustration-intro.svg"
    ...
    <section>
      ...
      <div
        className=" container flex flex-col-reverse 
            md:flex-row items-center px-6 mx-auto mt-10 space-y-0 
            md:space-y-0 "
      >
        {/* --left item */}
        <div className=" flex flex-col mb-32 space-y-12 md:w-1/2">
          ...
          <p
            className=" max-w-sm text-center text-darkGrayishBlue
                     md:text-left"
          >
